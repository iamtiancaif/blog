...
{:toc}
    ...
    IP地址又称逻辑地址,在OSI模型的网络层定义,并且依赖于网络层中的网络协议.不同网络层协议对应逻辑地址的格式也不同.[IP协议](https://www.baidu.com/s?wd=IP%E5%8D%8F%E8%AE%AE&from=1012015a&fenlei=mv6quAkxTZn0IZRqIHckPjm4nH00T1YYmhDzPhD1PHmYnWf3Pj0k0ZwV5Hcvrjm3rH6sPfKWUMw85HfYnjn4nH6sgvPsT6KdThsqpZwYTjCEQLGCpyw9Uz4Bmy-bIi4WUvYETgN-TLwGUv3EnHnzrH6Yn1Dk)对应IP地址.这个地址是32位的二进制数,包含两个部分:网络部分和主机(节点)部分
